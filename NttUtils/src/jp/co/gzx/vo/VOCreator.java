...
public final class VOCreator {
     ...
     * コンストラクタ
     */
    public VOCreator(String name) throws IOException {
        this.name = name;
...
//      toEqualsBuffer.append("    }").append("\r\n\r\n");
    ...
    private void outputClassHeader() throws IOException {
...
//        fileWriter.write(fileEndBuffer.toString());
    ...
    public static void main(String[] args) {
        try {
            String name = "ImiguzyGuyZndkSuryoDto";
            VOCreator creator = new VOCreator(name);
            creator.createClass();
